...
def test_warm_rebuild_is_byte_identical_and_makes_zero_llm_calls(
    ...
    monkeypatch.setattr("tutormoments.client.run_batch", _fake_run_batch)
    monkeypatch.setattr("tutormoments.client.ModelClient", _FakeClient)
    ...
    monkeypatch.setattr("tutormoments.client.run_batch", _boom)
    monkeypatch.setattr(
        "tutormoments.client.ModelClient",
