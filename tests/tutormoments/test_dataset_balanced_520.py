...
The canonical id list lives at tutormoments_build/balanced_520_ids.json (committed
...
# Repo root relative to this file: tests/tutormoments/ -> ../../
_REPO_ROOT = Path(__file__).parent.parent.parent
_RELEASE_DIR = _REPO_ROOT / "data" / "balanced_520_release"
_MOMENTS_FILE = _RELEASE_DIR / "moments.jsonl"
_IDS_FILE = _REPO_ROOT / "tutormoments_build" / "balanced_520_ids.json"
...
pytestmark = pytest.mark.skipif(
    ...
    reason="balanced_520 release not present locally (build with tutormoments-build dataset build)",
)
...
class TestOrderMatchesIdList:
    def test_order_matches_id_list(self, raw_moments, canonical_ids):
        """Moment order must match tutormoments_build/balanced_520_ids.json."""
...
class TestLoadMomentsRoundTrip:
    ...
    def test_manifest_hash_matches(self):
        ...
        from tutormoments.moments import validate_dataset
