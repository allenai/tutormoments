...
decompose/structure helpers are reused from tutormoments.client / tutormoments.scoring; the
situation/effectiveness helpers from tutormoments_build.classify. Model/params come from the
`groundtruth` config block (tutormoments.config.get_groundtruth_phase_config).
"""
...
from tutormoments.config import get_groundtruth_phase_config, get_labeller_config
...
from tutormoments_build.classify import (
    JUNK_TEXTS,
    VALID_LABELS,
...
# tutormoments_build/groundtruth.py -> tutormoments_build -> <repo root>
