You will be given a tutoring transcript that contains a cut point. Your job is to determine what pedagogical strategy a tutor decides to employ after the cut point, and whether that strategy relates to scaffolding, a push for rigor, both, or neither. 
