...
Moved from the runtime (src/tutormoments/student.py) when frozen personas were
...
# ---------------------------------------------------------------------------
# Adapter (wraps tutormoments.client.ModelClient)
# ---------------------------------------------------------------------------


class _ModelWrapperAdapter:
    """Thin shim around tutormoments ModelClient mimicking TraitGenerator's model interface.
